...
class PriceDisplay extends React.Component {
  ...
  static getDerivedStateFromProps(props, state) {
    if (props.price !== state.price) {
      return props.price < state.price
        ? { direction: "down", price: props.price }
        : { direction: "up", price: props.price };
    } else {
      return { direction: "", price: props.price };
    }
  }

  render() {
    let direction = this.state.direction; // get this from state instead
    return (
      <div
        style={{
